...
module.exports = {
    ...
    'post /soc/task.json' (req, res) {
        setTimeout(() => {
            res.json({ "value": { "createTime": "2017-06-08 09:09:04", "handleRemark": "", "handleTime": "", "handler": "", "msg": "[06-08 21:08 DIVIXWCN-eco0prod coBIService P1] [ecsProd-4-91 load1 6.4 > 5.0]", "status": "超时关闭", "taskId": 90, "taskType": "监控事件", "title": "coBIService系统告警", "urgencyDegree": "低" } });
        }, 200);
    },
